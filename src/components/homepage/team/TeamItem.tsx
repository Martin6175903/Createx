...
const TeamItem = ({ name, sphere, children }: ITeamItem<string>) => {
    ...
    return (
        <div className="w-[285px] h-[340px] bg-secondary rounded hover:cursor-pointer" onMouseEnter={hoverEnterItem} onMouseLeave={hoverLeaveItem}>
                    ...
                    <svg className="group/edit" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g className="opacity-[0.6] group-hover/edit:opacity-1">
                            <path
                                ...
                                fill="white"/>
                            <path d="M0.9415 6.2056H4.39706V17.3327H0.9415V6.2056Z" fill="white"/>
                            <path
