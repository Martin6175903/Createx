...
const SliderActionItem = ({itemActive, usePrevArrow, useNextArrow}: ISliderActionItem<boolean>) => {
    ...
    return (
        <div className={"flex gap-[30px] "
            ...
            // + (usePrevArrow ? "animate-slider-active-right" : "absolute -left-[2000px] top-0 animate-slider-translate-right")
            // + (useNextArrow ? "animate-slider-active-left" : "absolute -right-[2000px] top-0 animate-slider-translate-left")
        }>
            {/*"animate-slider-active-right" : "absolute -left-[2000px] top-0 animate-slider-translate-left"*/}
            {/*"animate-slider-active-left" : "absolute -right-[2000px] top-0 animate-slider-translate-right"*/}
            {itemsInfo.map(item =>
