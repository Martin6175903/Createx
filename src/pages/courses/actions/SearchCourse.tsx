    ...
    return (
        <div>
            <label className="relative group/edit cursor-pointer">
                <input className={"w-[315px] h-11 border-solid border-[1px] border-gray-400 rounded py-3 pl-4 pr-8 placeholder:text-[14px] placeholder:text-gray-600 duration-300 group-hover/edit:border-gray-700 focus-visible:outline-0"} type="text"
                       placeholder={"Search course..."}/>
                <svg className="absolute right-4 top-[calc(50%-8px)]" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g>
